...
(event.body.toLowerCase() == "Bow ki")) {
  ...
  if ((event.body.toLowerCase() == "𝐑𝐀𝐊𝐈𝐁 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘 ") || (event.body.toLowerCase() == "𝗠𝗢𝗛𝗔𝗠𝗠𝗔𝗗 𝗕𝗔𝗗𝗔𝗟 𝗖𝗛𝗢𝗪𝗗𝗛𝗨𝗥𝗬") || (event.body.toLowerCase() == "@𝗠𝗢𝗛𝗔𝗠𝗠𝗔𝗗 𝗕𝗔𝗗𝗔𝗟 𝗖𝗛𝗢𝗪𝗗𝗛𝗨𝗥𝗬 Khan") || (event.body.toLowerCase() == "𝗠𝗢𝗛𝗔𝗠𝗠𝗔𝗗 𝗕𝗔𝗗𝗔𝗟 𝗖𝗛𝗢𝗪𝗗𝗛𝗨𝗥𝗬 vai")) {
  ...
  if ((event.body.toLowerCase() == "Alif") || (event.body.toLowerCase() == "alif")) {
     return api.sendMessage("🥰-Alif-🌺 আমার বস 𝐑𝐀𝐊𝐈𝐁 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘 এর কলিজার Dadu লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Ongkon") || (event.body.toLowerCase() == "Munna") || (event.body.toLowerCase() == "Sanvi") || (event.body.toLowerCase() == "Zareb") || (event.body.toLowerCase() == "Jahid")) {
     return api.sendMessage("️এদের ডাকিস কেন জানিস না এরা 𝐑𝐀𝐊𝐈𝐁 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘 এর কলিজার ভাই ব্রাদার  লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
